...
import com.projetojpahospedagem.services.HospedeService;
...
public class HospedeController {
	...
	public ResponseEntity<Hospede> buscaHospedeControlId(@PathVariable long Codigo) {
		Hospede hospede = hospedeService.buscaHospedeId(Codigo);
		if (hospede != null)
	...
	@PostMapping("/")
	public ResponseEntity<Hospede> salvaHospedeoControl(@RequestBody Hospede hospede) {
